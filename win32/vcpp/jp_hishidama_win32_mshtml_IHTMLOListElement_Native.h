...
#include <jni.h>
/* Header for class jp_hishidama_win32_mshtml_IHTMLOListElement_Native */

#ifndef _Included_jp_hishidama_win32_mshtml_IHTMLOListElement_Native
#define _Included_jp_hishidama_win32_mshtml_IHTMLOListElement_Native
#ifdef __cplusplus
extern "C" {
#endif
/*
 * Class:     jp_hishidama_win32_mshtml_IHTMLOListElement_Native
 * Method:    put_compact
 * Signature: (JZ)V
 */
