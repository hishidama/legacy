...
public class HtLexerFunctionTest {
	...
	public void testURLEncoder() throws UnsupportedEncodingException {
		Object arg = "‚ ‚¢‚¤";
		testStaticEval(URLEncoder.encode("‚ ‚¢‚¤"), "URLEncoder_encode", arg);

		arg = "‚©‚«‚­‚¯‚±";
		testStaticEval(URLEncoder.encode("‚©‚«‚­‚¯‚±", "MS932"),
	...
	public void testURLDecoder() throws UnsupportedEncodingException {
		Object arg = URLEncoder.encode("‚ ‚¢‚¤");
		testStaticEval("‚ ‚¢‚¤", "URLDecoder_decode", arg);

		arg = URLEncoder.encode("‚©‚«‚­‚¯‚±", "MS932");
		testStaticEval("‚©‚«‚­‚¯‚±", "URLDecoder_decode", arg, "MS932");
	}
	...
	public void testString() {
		testEval(3, "‚ ‚¢‚¤", "String_length", new Object[] {});
		testEval("‚ ‚¢‚¤", "‚ ‚¢‚¤", "String_toString", new Object[] {});

		testEval(true, "‚ ‚¢‚¤‚¦‚¨", "String_startsWith", "‚ ‚¢‚¤");
		testEval(false, "‚ ‚¢‚¤‚¦‚¨", "String_startsWith", "‚¦‚¨");
		testEval(false, "‚ ‚¢‚¤‚¦‚¨", "String_endsWith", "‚ ‚¢‚¤");
		testEval(true, "‚ ‚¢‚¤‚¦‚¨", "String_endsWith", "‚¦‚¨");

		testEval(2, "‚ ‚¢‚¤‚¦‚¨", "String_indexOf", "‚¤‚¦");

		testEval(false, "abc", "String_containsZenkaku");
		testEval(true, "ab‚ c", "String_containsZenkaku");
	}
